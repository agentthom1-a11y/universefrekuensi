  ...
  return (
    <section id="aether-product" className="bg-brand-dark border-b border-brand-light/10">
      <div className="flex flex-col lg:flex-row min-h-[70vh]">
        ...
        <div className="flex-1 bg-brand-dark px-6 py-16 md:px-12 md:py-20 lg:px-16 xl:px-20 2xl:px-24 flex flex-col justify-center items-center lg:items-start relative">
          <motion.div 
